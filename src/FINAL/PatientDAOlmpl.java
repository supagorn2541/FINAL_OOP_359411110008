...
public class PatientDAOlmpl implements PatientDAO {
    ...
    public static String url = "jdbc:sqlite:C:/Users/JOJOE/IdeaProjects/FINAL_OOP_359411110008/Hospital.sqlite";
    ...
    public static final String UPDATE_PAT_BY_ID="Select*from patient set p_name=?,p_gender=?,p_age=?,p_address=?,p_blood_result=?where p_id";
    ...
    public void updatePAT(Patient PAT) {
            ...
            try {
                conn = DriverManager.getConnection(url);
                PreparedStatement ps = conn.prepareStatement(UPDATE_PAT_BY_ID);
